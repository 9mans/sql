...
FROM EMPLOYEES E, DEPARTMANES D, LOCATIONS L
...
-- WHERE SUBSTR(E.FIRST_NAME, 1, 1) IN ('a', 'A') 이런식으로도 가능하다
AND E.DEPARTMENT_ID = D.DEPARTMENT_ID
...
SELECT E.EMPLOYEE_ID, E.JOB_ID, J.JOB_TILTE, E.SALARY, G.GRADE, DEPARTMENT D 
...
SELECT E.EMPLOYEE_ID, E.FIRST_NAME, E.SALARY, E.SALARY + E.SALARY*NVL(COMMISSION_PCT, 0) REAL_SALARY, G.GRADE, E.JOB_ID, D.DEPARTMENT_ID, D.DEPARTMENT_NAME, L.CITY
