/*
    ...
    권한의 종류
            시스템 권한
                    ...
                    데이터베이스 관리자만 시스템 권한을 부여/회수 할 수 있다
            
            객체권한
                    데이터베이스 객체의 내용을 조회/조작할 수 있는 권한
                    데이터베이스 객체를 소유하고 있는 사용자가 객체권한을 부여/회수할 수 있다
...
/*
    ...
    _ORALCLE_SCRIPT를 TRUE로 설정하면 C##을 붙이지 않고 사용자를 생성할 수 있다
*/
...
-- 사용자에게 롤이 포함하고 있는 모든 시스템권한을 부여하기
...
CREATE TABLE                        -- 자신의 소유 테이블을 생성하는 시스템 권한
CREATE ANY TABLE                 -- 임의의 소유 테이블을 생성하는 시스템 권한

DROP TABLE                            -- 자신의 소유 테이블을 제거하는 시스템 권한
DROP ANY TABLE                     -- 임의의 소유 테이블을 제거하는 시스템 권한
