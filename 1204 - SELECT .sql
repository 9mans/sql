...
1. 지정된 테이블 모든 행, 모든 열 조회
SELECT *
FROM 테이블명;

2. 지정된 테이블의 모든 행 지정된 열 조회하기
SELECT 컬럼명, 컬럼명, 컬럼명*
FROM 테이블명;

3. SELECT절에서 사칙연산을 수행할 수 있따
...
-- 급여가 5000 이상, 10000 이하로 받는 직원을 조회하기
SELECT EMPLOYEE_ID, FIRST_NAME, JOB_ID, SALARY
FROM EMPLOYEES
